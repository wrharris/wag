...
(* wrharris: extensions. *)
val call_get_called_function: llvalue -> llvalue option

val get_normal_dest: llvalue -> llbasicblock

val get_unwind_dest: llvalue -> llbasicblock

val get_num_successors: llvalue -> int

val get_successor: llvalue -> int -> llbasicblock

val get_addr: llvalue -> int

val invoke_get_called_function: llvalue -> llvalue option
