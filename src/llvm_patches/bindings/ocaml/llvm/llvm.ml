...
(* wrharris extensions. *)
external call_get_called_function: llvalue -> llvalue option =
"llvm_call_get_called_function"
...
external get_num_successors: llvalue -> int = "llvm_get_num_successors"

external get_successor: llvalue -> int -> llbasicblock = "llvm_get_successor"

external invoke_get_called_function: llvalue -> llvalue option =
"llvm_invoke_get_called_function"

external get_addr: llvalue -> int = "llvm_get_addr"
