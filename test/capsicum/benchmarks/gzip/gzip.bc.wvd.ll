...
; <label>:71                                      ; preds = %70, %59
  ...
  call void @wg_read_action(i32 4)
  br label %75, !dbg !286
...
; <label>:203                                     ; preds = %227, %202
  ...
  %callee_cast = bitcast i32 (i32, i32)* %204 to i8*
  %wrapped = call i8* %trans_fn(i8* %callee_cast)
  %test = bitcast i8* %wrapped to i32 (i32, i32)*
  %207 = call i32 %test(i32 %205, i32 %206), !dbg !506
  %cast_call_28735336 = bitcast i32 (i32, i32)* %test to i8*
  call void @wg_read_ret(i8* %cast_call_28735336)
...
; <label>:135                                     ; preds = %132, %127
  ...
  %trans_fn = load i8* (i8*)** @trans_func
  %callee_cast = bitcast i32 (i32, i32)* %137 to i8*
  %wrapped = call i8* %trans_fn(i8* %callee_cast)
  %test = bitcast i8* %wrapped to i32 (i32, i32)*
  %140 = call i32 %test(i32 %138, i32 %139), !dbg !606
  %cast_call_28781768 = bitcast i32 (i32, i32)* %test to i8*
  call void @wg_read_ret(i8* %cast_call_28781768)
...
define i32 @zip(i32 %in, i32 %out) nounwind uwtable {
  ...
  call void @wg_read_action(i32 68)
  ...
  call void @store_fd(i32 %3, i32* @0)
  ...
  %"ld_glob_ 4" = load i32* @noop_glob
  call void @wg_read_succ(i32 69)
  call void @wg_read_action(i32 69)
  %noop_8 = add i32 %"ld_glob_ 4", %"ld_glob_ 4"
  call void @wg_read_succ(i32 70)
  call void @wg_read_action(i32 70)
  %noop_7 = add i32 %noop_8, %noop_8
  call void @wg_read_succ(i32 71)
  call void @wg_read_action(i32 71)
  %noop_6 = add i32 %noop_7, %noop_7
  call void @wg_read_succ(i32 72)
  call void @wg_read_action(i32 72)
  ...
  call void @store_fd(i32 %5, i32* @1)
  %ld_inter_glob_742 = load i32* @noop_glob
  %inter_noop_742 = add i32 %ld_inter_glob_742, %ld_inter_glob_742
  %"ld_glob_ 8" = load i32* @noop_glob
  call void @wg_read_succ(i32 73)
  call void @wg_read_action(i32 73)
  %noop_12 = add i32 %"ld_glob_ 8", %"ld_glob_ 8"
  ...
  %noop_9 = add i32 %noop_10, %noop_10
...
; <label>:217                                     ; preds = %192
  ...
  call void @wg_read_action(i32 41)
...
; <label>:229                                     ; preds = %228, %217
  ...
  call void @wg_read_action(i32 43)
...
; <label>:391                                     ; preds = %390, %345
  ...
  %"ld_glob_ 12" = load i32* @noop_glob
  call void @wg_read_action(i32 77)
  %noop_16 = add i32 %"ld_glob_ 12", %"ld_glob_ 12"
  call void @wg_read_succ(i32 62)
  call void @wg_read_action(i32 62)
  %noop_15 = add i32 %noop_16, %noop_16
  call void @wg_read_succ(i32 63)
  call void @wg_read_action(i32 63)
  %noop_14 = add i32 %noop_15, %noop_15
  call void @wg_read_succ(i32 64)
  call void @wg_read_action(i32 64)
  %noop_13 = add i32 %noop_14, %noop_14
...
define i32 @marshall_zip(i32, i32) {
entry:
  %arg_slot_0 = alloca i32
  %arg_slot_1 = alloca i32
  ...
  store i32 %1, i32* %arg_slot_1
  %arg_1 = getelementptr { i8*, i64 }* %arg_iovec, i32 1, i32 0
  %catch_vp1 = call i8* @int_to_voidp(i32* %arg_slot_1)
  store i8* %catch_vp1, i8** %arg_1
  %sz_param_1 = call i64 @int_size(i32 %1)
  ...
  %work_call = call { i8*, i64 }* %setup_fn(i32 1, { i8*, i64 }* %arg_iovec, i32 2)
...
define { i8*, i64 }* @unmarshall_zip({ i8*, i64 }*) {
entry:
  ...
  %arg_1 = call i32 @voidpp_to_int(i8* %arg_buf_1)
  %work_res = call i32 @zip(i32 %arg_0, i32 %arg_1)
