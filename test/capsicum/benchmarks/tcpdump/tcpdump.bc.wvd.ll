...
; <label>:394                                     ; preds = %390
  ...
  call void @wg_read_action(i32 34)
...
; <label>:420                                     ; preds = %416
  ...
  call void @wg_read_action(i32 6)
  ...
  call void @wg_read_action(i32 39)
...
; <label>:491                                     ; preds = %487
  ...
  call void @wg_read_action(i32 66)
...
; <label>:606                                     ; preds = %599
  ...
  call void @wg_read_action(i32 90)
...
; <label>:609                                     ; preds = %606, %599
  ...
  call void @wg_read_action(i32 92)
...
; <label>:617                                     ; preds = %613
  ...
  call void @wg_read_action(i32 98)
  br label %622
...
; <label>:622                                     ; preds = %617, %615
  ...
  call void @wg_read_action(i32 100)
...
; <label>:630                                     ; preds = %622
  ...
  call void @wg_read_succ(i32 101)
...
; <label>:635                                     ; preds = %633
  ...
  call void @wg_read_action(i32 103)
  ...
  call void @wg_read_succ(i32 104)
...
; <label>:637                                     ; preds = %633
  ...
  call void @wg_read_action(i32 105)
  ...
  call void @wg_read_succ(i32 106)
  ...
  call void @wg_read_succ(i32 107)
  ...
  call void @wg_read_action(i32 108)
  ...
  call void @wg_read_succ(i32 109)
  ...
  call void @wg_read_action(i32 111)
...
; <label>:646                                     ; preds = %637
  ...
  call void @wg_read_succ(i32 112)
...
; <label>:648                                     ; preds = %646, %637
  ...
  call void @wg_read_action(i32 113)
...
; <label>:651                                     ; preds = %648
  ...
  call void @wg_read_succ(i32 114)
...
; <label>:659                                     ; preds = %656
  ...
  call void @wg_read_succ(i32 119)
...
; <label>:670                                     ; preds = %666
  ...
  call void @wg_read_action(i32 122)
...
; <label>:675                                     ; preds = %670, %666, %659
  ...
  call void @wg_read_succ(i32 123)
...
; <label>:736                                     ; preds = %734, %728
  ...
  call void @wg_read_action(i32 124)
...
; <label>:740                                     ; preds = %736
  ...
  call void @wg_read_succ(i32 125)
...
; <label>:742                                     ; preds = %695
  ...
  call void @wg_read_succ(i32 126)
...
; <label>:760                                     ; preds = %764, %758
  ...
  call void @wg_read_action(i32 127)
...
; <label>:769                                     ; preds = %760
  ...
  call void @wg_read_succ(i32 128)
...
; <label>:781                                     ; preds = %779, %740, %736
  ...
  call void @wg_read_action(i32 129)
...
; <label>:782                                     ; preds = %781
  ...
  call void @wg_read_succ(i32 130)
...
._crit_edge346:                                   ; preds = %782, %781
  ...
  call void @wg_read_action(i32 131)
...
; <label>:787                                     ; preds = %._crit_edge346
  ...
  call void @wg_read_succ(i32 132)
...
; <label>:801                                     ; preds = %799, %797
  ...
  call void @wg_read_action(i32 136)
  ...
  call void @wg_read_succ(i32 137)
  ...
  call void @wg_read_action(i32 138)
...
; <label>:812                                     ; preds = %801
  ...
  call void @wg_read_succ(i32 139)
...
; <label>:821                                     ; preds = %818, %790
  ...
  %noop_4 = add i32 %"ld_glob_ 0", %"ld_glob_ 0"
  call void @wg_read_succ(i32 148)
  call void @wg_read_action(i32 148)
  %noop_3 = add i32 %noop_4, %noop_4
  call void @wg_read_succ(i32 149)
  call void @wg_read_action(i32 149)
  %noop_2 = add i32 %noop_3, %noop_3
  call void @wg_read_succ(i32 150)
  call void @wg_read_action(i32 150)
  %noop_1 = add i32 %noop_2, %noop_2
  call void @wg_read_succ(i32 140)
  call void @wg_read_action(i32 140)
  ...
  call void @wg_read_succ(i32 141)
...
; <label>:846                                     ; preds = %__sputc.exit, %821
  ...
  call void @wg_read_action(i32 142)
...
; <label>:848                                     ; preds = %846
  ...
  call void @wg_read_succ(i32 143)
...
; <label>:855                                     ; preds = %854
  ...
  call void @wg_read_action(i32 145)
...
; <label>:856                                     ; preds = %855, %854
  ...
  call void @wg_read_succ(i32 146)
...
; <label>:17                                      ; preds = %0
  ...
  %callee_cast = bitcast i32 (%struct.netdissect_options*, %struct.pcap_pkthdr*, i8*)* %19 to i8*
  %wrapped = call i8* %trans_fn(i8* %callee_cast)
  %cast_call_90110720 = bitcast i8* (i8*)* %trans_fn to i8*
  call void @wg_read_ret(i8* %cast_call_90110720)
  %test = bitcast i8* %wrapped to i32 (%struct.netdissect_options*, %struct.pcap_pkthdr*, i8*)*
  %22 = tail call i32 %test(%struct.netdissect_options* %21, %struct.pcap_pkthdr* %h, i8* %sp) nounwind, !dbg !2270
  %cast_call_39259248 = bitcast i32 (%struct.netdissect_options*, %struct.pcap_pkthdr*, i8*)* %test to i8*
  call void @wg_read_ret(i8* %cast_call_39259248)
...
; <label>:23                                      ; preds = %0
  ...
  %callee_cast2 = bitcast i32 (%struct.pcap_pkthdr*, i8*)* %25 to i8*
  %wrapped3 = call i8* %trans_fn1(i8* %callee_cast2)
  %cast_call_90127136 = bitcast i8* (i8*)* %trans_fn1 to i8*
  call void @wg_read_ret(i8* %cast_call_90127136)
  %test4 = bitcast i8* %wrapped3 to i32 (%struct.pcap_pkthdr*, i8*)*
  %26 = tail call i32 %test4(%struct.pcap_pkthdr* %h, i8* %sp) nounwind, !dbg !2273
  %cast_call_39260024 = bitcast i32 (%struct.pcap_pkthdr*, i8*)* %test4 to i8*
  call void @wg_read_ret(i8* %cast_call_39260024)
...
define i8* @marshall_getname(i8*) {
entry:
  ret i8* null
}

define { i8*, i64 }* @unmarshall_getname({ i8*, i64 }*) {
entry:
  ret { i8*, i64 }* null
}
