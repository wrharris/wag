...
; <label>:167                                     ; preds = %166, %164, %160
  ...
  %trans_fn = load i8* (i8*)** @trans_func
  %wrapped = call i8* %trans_fn(i8* bitcast (i32 (%struct.url*, %struct.http_stat*, i32*, %struct.url*)* @gethttp to i8*))
  %cast_call_44934128 = bitcast i8* (i8*)* %trans_fn to i8*
  call void @wg_read_ret(i8* %cast_call_44934128)
  %test = bitcast i8* %wrapped to i32 (%struct.url*, %struct.http_stat*, i32*, %struct.url*)*
  %174 = call fastcc i32 %test(%struct.url* %u, %struct.http_stat* %hstat, i32* %dt, %struct.url* %proxy)
  %cast_call_41615368 = bitcast i32 (%struct.url*, %struct.http_stat*, i32*, %struct.url*)* %test to i8*
  call void @wg_read_ret(i8* %cast_call_41615368)
...
; <label>:12                                      ; preds = %10
  ...
  call void @wg_read_succ(i32 103)
  call void (i32, i8*, ...)* @logprintf(i32 1, i8* %13) nounwind
  call void @wg_read_action(i32 104)
  br label %945
...
; <label>:14                                      ; preds = %10, %0
  ...
  call void @wg_read_succ(i32 105)
...
; <label>:30                                      ; preds = %25, %14
  ...
  call void @wg_read_action(i32 106)
  br i1 %6, label %31, label %38

; <label>:31                                      ; preds = %30
  %32 = load i32* %7, align 4, !tbaa !10
  %33 = icmp eq i32 %32, 1
  call void @wg_read_action(i32 107)
...
; <label>:38                                      ; preds = %31, %30
  ...
  call void @wg_read_succ(i32 108)
...
; <label>:51                                      ; preds = %47
  ...
  call void @wg_read_succ(i32 111)
...
; <label>:54                                      ; preds = %51, %47
  ...
  call void @wg_read_action(i32 112)
...
; <label>:57                                      ; preds = %54
  ...
  call void @wg_read_succ(i32 113)
  ...
  call void @wg_read_action(i32 114)
  br label %64

; <label>:60                                      ; preds = %54
  %61 = load i8* %55, align 1, !tbaa !1
  %62 = icmp eq i8 %61, 0
  call void @wg_read_action(i32 115)
...
; <label>:63                                      ; preds = %60
  ...
  call void @wg_read_action(i32 116)
  br label %64
...
; <label>:64                                      ; preds = %63, %60, %57
  ...
  call void @wg_read_succ(i32 117)
...
; <label>:87                                      ; preds = %82, %78
  ...
  call void @wg_read_action(i32 118)
...
; <label>:92                                      ; preds = %87
  ...
  call void @wg_read_action(i32 119)
...
; <label>:97                                      ; preds = %92
  ...
  call void @wg_read_action(i32 120)
  br label %100
...
; <label>:100                                     ; preds = %97, %92, %87
  ...
  call void @wg_read_succ(i32 121)
  call void @wg_read_action(i32 121)
  ...
  call void @wg_read_succ(i32 122)
...
; <label>:116                                     ; preds = %115, %100
  ...
  call void @wg_read_action(i32 123)
...
; <label>:119                                     ; preds = %116
  ...
  call void @wg_read_succ(i32 124)
...
; <label>:133                                     ; preds = %128
  ...
  call void @wg_read_action(i32 125)
...
; <label>:136                                     ; preds = %133
  ...
  call void @wg_read_action(i32 126)
  br label %149
...
; <label>:138                                     ; preds = %133
  ...
  call void @wg_read_succ(i32 127)
  %140 = call i64 @file_size(i8* %139) nounwind
  %141 = icmp eq i64 %140, -1
  call void @wg_read_action(i32 128)
...
; <label>:142                                     ; preds = %138
  ...
  call void @wg_read_succ(i32 129)
  call void (i32, i8*, ...)* @logprintf(i32 1, i8* %143, i8* %145, i8* %148) nounwind
  call void @wg_read_action(i32 130)
  br label %149
...
; <label>:149                                     ; preds = %142, %138, %136
  ...
  call void @wg_read_succ(i32 131)
...
; <label>:180                                     ; preds = %177, %172
  ...
  call void @wg_read_action(i32 132)
...
; <label>:183                                     ; preds = %180
  ...
  call void @wg_read_succ(i32 133)
...
; <label>:190                                     ; preds = %189
  ...
  call void @wg_read_action(i32 134)
...
; <label>:201                                     ; preds = %190
  ...
  call void @wg_read_succ(i32 135)
  call void @wg_read_action(i32 135)
  ...
  call void @wg_read_succ(i32 136)
  ...
  call void @wg_read_action(i32 137)
...
; <label>:210                                     ; preds = %201
  ...
  call void @wg_read_succ(i32 138)
...
; <label>:215                                     ; preds = %190
  ...
  call void @wg_read_action(i32 141)
...
; <label>:218                                     ; preds = %215
  ...
  call void @wg_read_succ(i32 142)
  call void (i32, i8*, ...)* @logprintf(i32 1, i8* %219, i8* %220, i8* %222) nounwind
  call void @wg_read_action(i32 143)
  br label %945
...
; <label>:223                                     ; preds = %215, %214, %211, %189
  ...
  call void @wg_read_action(i32 144)
...
; <label>:225                                     ; preds = %223
  ...
  call void @wg_read_succ(i32 145)
...
; <label>:232                                     ; preds = %225
  ...
  call fastcc void @request_free(%struct.request* %24)
  call void @wg_read_action(i32 146)
  br label %945

; <label>:233                                     ; preds = %225
  %234 = icmp slt i32 %230, 0
  call void @wg_read_action(i32 147)
...
; <label>:241                                     ; preds = %240
  ...
  call void @wg_read_action(i32 150)
...
; <label>:244                                     ; preds = %241
  ...
  call void @wg_read_succ(i32 151)
  ...
  call void @wg_read_action(i32 152)
...
; <label>:251                                     ; preds = %244
  ...
  call void @wg_read_succ(i32 153)
...
; <label>:258                                     ; preds = %257, %254, %251
  ...
  call void @wg_read_action(i32 154)
...
; <label>:261                                     ; preds = %260, %258
  ...
  call void @wg_read_action(i32 157)
...
; <label>:264                                     ; preds = %261
  ...
  call void @wg_read_action(i32 158)
...
; <label>:272                                     ; preds = %269
  ...
  call void @wg_read_succ(i32 164)
  call void @wg_read_action(i32 164)
  ...
  call void @wg_read_succ(i32 165)
  ...
  call void @wg_read_action(i32 166)
...
; <label>:277                                     ; preds = %272
  ...
  call fastcc void @invalidate_persistent()
  call void @wg_read_action(i32 167)
  br label %945

; <label>:278                                     ; preds = %272
  %ld_inter_glob_398 = load i32* @noop_glob
  %inter_noop_398 = add i32 %ld_inter_glob_398, %ld_inter_glob_398
  call void @wg_read_succ(i32 168)
  call void @fd_close(i32 %230) nounwind
  call void @wg_read_action(i32 169)
  br label %945
...
; <label>:283                                     ; preds = %279
  ...
  call void @wg_read_action(i32 170)
...
; <label>:287                                     ; preds = %286, %283
  ...
  call void @wg_read_succ(i32 173)
...
.loopexit103:                                     ; preds = %287, %282
  ...
  call void @wg_read_action(i32 174)
...
; <label>:296                                     ; preds = %.loopexit103
  ...
  call void @wg_read_succ(i32 175)
  %297 = call i8* @quotearg_style(i32 5, i8* %294) nounwind
  call void @wg_read_action(i32 176)
  br label %298
...
; <label>:302                                     ; preds = %298
  ...
  call void @wg_read_action(i32 179)
  br label %945
...
; <label>:318                                     ; preds = %314, %307, %223
  ...
  call void @wg_read_succ(i32 189)
...
; <label>:324                                     ; preds = %321
  ...
  call void @wg_read_action(i32 190)
...
; <label>:328                                     ; preds = %327, %324
  ...
  call void @wg_read_succ(i32 193)
...
; <label>:331                                     ; preds = %321
  ...
  call void @wg_read_action(i32 194)
...
; <label>:334                                     ; preds = %331
  ...
  call void @wg_read_succ(i32 195)
...
; <label>:336                                     ; preds = %334, %331, %328
  ...
  call void @wg_read_action(i32 196)
...
.thread:                                          ; preds = %336, %318
  ...
  call void @wg_read_action(i32 197)
...
; <label>:341                                     ; preds = %.thread
  ...
  call void @wg_read_succ(i32 198)
...
; <label>:342                                     ; preds = %341, %340
  ...
  call fastcc void @request_free(%struct.request* %24)
  call void @wg_read_action(i32 199)
  br label %945
...
; <label>:343                                     ; preds = %336
  ...
  call void @wg_read_succ(i32 200)
  call void @wg_read_action(i32 200)
  ...
  call void @wg_read_succ(i32 201)
...
; <label>:349                                     ; preds = %343
  ...
  call void @wg_read_action(i32 202)
...
; <label>:353                                     ; preds = %349
  ...
  call void @wg_read_succ(i32 203)
  ...
  call void @wg_read_action(i32 204)
...
; <label>:358                                     ; preds = %353
  ...
  call void @wg_read_succ(i32 205)
  call void @fd_close(i32 %sock.2) nounwind
  br label %359
...
; <label>:359                                     ; preds = %358, %357
  ...
  call fastcc void @request_free(%struct.request* %24)
  call void @wg_read_action(i32 206)
  br label %945
...
; <label>:360                                     ; preds = %349
  ...
  call void @wg_read_succ(i32 207)
  call void @wg_read_action(i32 207)
  ...
  call void @wg_read_succ(i32 208)
  ...
  call void @wg_read_action(i32 209)
...
; <label>:366                                     ; preds = %360
  ...
  call void @wg_read_succ(i32 210)
  call void @fd_close(i32 %sock.2) nounwind
  br label %367
...
; <label>:372                                     ; preds = %371, %368
  ...
  call void @wg_read_succ(i32 215)
...
; <label>:384                                     ; preds = %382, %379
  ...
  call void @wg_read_succ(i32 220)
...
; <label>:386                                     ; preds = %372
  ...
  call void @wg_read_succ(i32 221)
  call void @wg_read_action(i32 221)
  ...
  call void @wg_read_succ(i32 222)
...
; <label>:390                                     ; preds = %387
  ...
  call void @wg_read_action(i32 223)
...
; <label>:392                                     ; preds = %390
  ...
  call void @wg_read_succ(i32 224)
...
.preheader97:                                     ; preds = %415, %412
  ...
  call void @wg_read_action(i32 225)
...
.lr.ph99:                                         ; preds = %.lr.ph99, %.preheader97
  ...
  call void @wg_read_succ(i32 226)
...
; <label>:437                                     ; preds = %.loopexit98
  ...
  call void @wg_read_succ(i32 229)
...
; <label>:446                                     ; preds = %444
  ...
  call void @wg_read_action(i32 230)
...
; <label>:447                                     ; preds = %446
  ...
  call void @wg_read_succ(i32 231)
...
; <label>:450                                     ; preds = %449
  ...
  call void @wg_read_action(i32 232)
...
; <label>:454                                     ; preds = %450
  ...
  call void @wg_read_succ(i32 233)
  call void @fd_close(i32 %sock.2) nounwind
  br label %460
...
; <label>:455                                     ; preds = %447, %446
  ...
  call void @wg_read_action(i32 234)
...
; <label>:459                                     ; preds = %455
  ...
  call void @wg_read_succ(i32 235)
  call void @fd_close(i32 %sock.2) nounwind
  br label %460
...
.preheader100:                                    ; preds = %471, %466
  ...
  call void @wg_read_action(i32 239)
...
; <label>:476                                     ; preds = %471
  ...
  call void @wg_read_action(i32 240)
...
.thread85:                                        ; preds = %.preheader100
  ...
  call void @wg_read_succ(i32 241)
  call void @logputs(i32 1, i8* %486) nounwind
  call void @wg_read_action(i32 242)
  br label %.critedge
...
; <label>:493                                     ; preds = %490, %487, %476
  ...
  call void @wg_read_succ(i32 245)
...
; <label>:510                                     ; preds = %507
  ...
  call void @wg_read_action(i32 246)
...
.critedge37:                                      ; preds = %510, %510, %510, %510, %510, %510, %510
  ...
  call void @wg_read_succ(i32 247)
...
.critedge:                                        ; preds = %490, %490, %490, %490, %490, %490, %490, %.thread85, %466, %463, %460
  ...
  call void @wg_read_succ(i32 248)
...
; <label>:522                                     ; preds = %521, %.critedge
  ...
  call void @free(i8* %347)
  call void @wg_read_action(i32 249)
  br label %945
...
; <label>:531                                     ; preds = %527
  ...
  call void @wg_read_action(i32 250)
...
; <label>:539                                     ; preds = %537, %534, %531
  ...
  call void @wg_read_succ(i32 254)
...
; <label>:541                                     ; preds = %539, %537, %527
  ...
  call void @wg_read_action(i32 255)
...
; <label>:545                                     ; preds = %541
  ...
  call void @wg_read_succ(i32 256)
...
; <label>:548                                     ; preds = %545
  ...
  call void @wg_read_action(i32 257)
...
; <label>:552                                     ; preds = %548
  ...
  call void @wg_read_succ(i32 258)
  call void @wg_read_action(i32 258)
  ...
  call void @wg_read_succ(i32 259)
...
; <label>:563                                     ; preds = %560, %552
  ...
  call void @wg_read_action(i32 260)
...
; <label>:566                                     ; preds = %563
  ...
  call void @wg_read_action(i32 261)
  br label %945
...
; <label>:573                                     ; preds = %567
  ...
  call void @wg_read_action(i32 262)
...
; <label>:576                                     ; preds = %573
  ...
  call void @wg_read_succ(i32 263)
...
; <label>:632                                     ; preds = %630, %627, %620
  ...
  call void @wg_read_action(i32 264)
...
; <label>:636                                     ; preds = %635, %632
  ...
  call void @wg_read_action(i32 267)
...
; <label>:639                                     ; preds = %636
  ...
  call void @wg_read_action(i32 268)
...
.critedge39:                                      ; preds = %643, %switch.edge
  ...
  call void @wg_read_action(i32 269)
  br label %646
...
; <label>:646                                     ; preds = %.critedge39, %639, %636
  ...
  call void @wg_read_succ(i32 270)
  call void @wg_read_action(i32 270)
  ...
  call void @wg_read_succ(i32 271)
...
; <label>:667                                     ; preds = %663
  ...
  call void @wg_read_action(i32 381)
  %noop_3 = add i32 %"ld_glob_ 0", %"ld_glob_ 0"
  call void @wg_read_succ(i32 382)
  call void @wg_read_action(i32 382)
  %noop_2 = add i32 %noop_3, %noop_3
  call void @wg_read_succ(i32 383)
  call void @wg_read_action(i32 383)
  %noop_1 = add i32 %noop_2, %noop_2
  call void @wg_read_succ(i32 272)
  call void @wg_read_action(i32 272)
  call void @cw_act(i32 0) nounwind
  call void @wg_read_succ(i32 273)
...
; <label>:674                                     ; preds = %668, %667
  ...
  call void @wg_read_action(i32 274)
...
; <label>:678                                     ; preds = %674
  ...
  call void @wg_read_succ(i32 275)
...
; <label>:682                                     ; preds = %680, %678
  ...
  call void @wg_read_action(i32 276)
...
; <label>:686                                     ; preds = %682
  ...
  call void @wg_read_action(i32 277)
  br label %688
...
; <label>:688                                     ; preds = %686, %682
  ...
  call void @wg_read_succ(i32 278)
  ...
  call void @wg_read_action(i32 279)
...
; <label>:690                                     ; preds = %688
  ...
  call void @wg_read_succ(i32 280)
...
; <label>:693                                     ; preds = %692
  ...
  call void @wg_read_action(i32 281)
...
; <label>:697                                     ; preds = %693
  ...
  call void @wg_read_succ(i32 282)
  call void @fd_close(i32 %sock.2) nounwind
  br label %703
...
; <label>:698                                     ; preds = %690, %688
  ...
  call void @wg_read_action(i32 283)
...
; <label>:702                                     ; preds = %698
  ...
  call void @wg_read_succ(i32 284)
  call void @fd_close(i32 %sock.2) nounwind
  br label %703
...
; <label>:705                                     ; preds = %704, %703
  ...
  call void @free(i8* %347)
  call void @wg_read_action(i32 285)
  br label %945
...
; <label>:731                                     ; preds = %728
  ...
  call void @wg_read_action(i32 286)
...
; <label>:734                                     ; preds = %731
  ...
  call void @wg_read_succ(i32 287)
...
; <label>:735                                     ; preds = %731
  ...
  call void @wg_read_action(i32 288)
...
; <label>:738                                     ; preds = %735
  ...
  call void @wg_read_succ(i32 289)
...
; <label>:739                                     ; preds = %738, %735, %734, %728
  ...
  call void @wg_read_action(i32 290)
...
; <label>:741                                     ; preds = %739
  ...
  call void @wg_read_action(i32 291)
...
; <label>:747                                     ; preds = %741, %739
  ...
  call void @wg_read_succ(i32 292)
...
; <label>:752                                     ; preds = %751, %747
  ...
  call void @wg_read_action(i32 293)
...
; <label>:756                                     ; preds = %752
  ...
  call void @wg_read_succ(i32 294)
  call void @fd_close(i32 %sock.2) nounwind
  br label %757
...
; <label>:757                                     ; preds = %756, %755
  ...
  call void @free(i8* %347)
  call void @wg_read_action(i32 295)
  br label %945
...
; <label>:765                                     ; preds = %764, %763
  ...
  call void @wg_read_action(i32 296)
...
; <label>:787                                     ; preds = %786
  ...
  call void @wg_read_action(i32 87)
...
; <label>:789                                     ; preds = %787
  ...
  call void @wg_read_succ(i32 88)
  call void @wg_read_action(i32 88)
  ...
  call void @wg_read_succ(i32 89)
  call void @wg_read_action(i32 89)
...
; <label>:793                                     ; preds = %787
  ...
  call void @wg_read_succ(i32 91)
  call void @wg_read_action(i32 91)
...
; <label>:799                                     ; preds = %796
  ...
  call void @wg_read_action(i32 93)
  br label %803
...
; <label>:801                                     ; preds = %796
  ...
  call void @wg_read_action(i32 94)
  br label %803
...
.thread91:                                        ; preds = %805
  ...
  call void @wg_read_succ(i32 97)
  call void @wg_read_action(i32 97)
...
.thread92:                                        ; preds = %805
  ...
  call void @wg_read_succ(i32 297)
  call void @logputs(i32 0, i8* getelementptr inbounds ([2 x i8]* @.str8, i64 0, i64 0)) nounwind
  br label %809
...
; <label>:815                                     ; preds = %814
  ...
  call void @wg_read_action(i32 298)
...
; <label>:819                                     ; preds = %815
  ...
  call void @wg_read_succ(i32 299)
  call void @fd_close(i32 %sock.2) nounwind
  br label %.thread93

; <label>:820                                     ; preds = %813
  call void @wg_read_action(i32 300)
...
; <label>:821                                     ; preds = %820
  ...
  call void @wg_read_succ(i32 301)
...
; <label>:823                                     ; preds = %821, %820
  ...
  call void @wg_read_action(i32 302)
...
; <label>:827                                     ; preds = %823
  ...
  call void @wg_read_succ(i32 303)
  call void @fd_close(i32 %sock.2) nounwind
  br label %.thread93
...
; <label>:831                                     ; preds = %828
  ...
  call void @wg_read_succ(i32 306)
  ...
  call void @wg_read_action(i32 307)
...
; <label>:836                                     ; preds = %831
  ...
  call void @wg_read_succ(i32 308)
...
; <label>:851                                     ; preds = %844
  ...
  call void @wg_read_action(i32 309)
...
; <label>:859                                     ; preds = %851
  ...
  call void @wg_read_succ(i32 310)
...
; <label>:863                                     ; preds = %859
  ...
  call void @wg_read_action(i32 311)
...
; <label>:867                                     ; preds = %863
  ...
  call void @wg_read_succ(i32 312)
  ...
  call void @wg_read_action(i32 313)
...
; <label>:873                                     ; preds = %867
  ...
  call void @wg_read_succ(i32 314)
  call void @fd_close(i32 %sock.2) nounwind
  br label %874
...
.thread94:                                        ; preds = %875, %863
  ...
  call void @wg_read_succ(i32 317)
  ...
  call void @wg_read_action(i32 318)
...
; <label>:884                                     ; preds = %.thread94
  ...
  call void @wg_read_succ(i32 319)
  call void @fd_close(i32 %sock.2) nounwind
  br label %885
...
; <label>:885                                     ; preds = %884, %883
  ...
  call void @free(i8* %347)
  call void @wg_read_action(i32 320)
  br label %945
...
; <label>:897                                     ; preds = %893
  ...
  call void @wg_read_action(i32 321)
  br label %902
...
; <label>:899                                     ; preds = %893, %888
  ...
  call void @wg_read_action(i32 322)
  br label %902
...
; <label>:902                                     ; preds = %899, %897
  ...
  call void @wg_read_succ(i32 323)
...
; <label>:910                                     ; preds = %907
  ...
  call void @wg_read_action(i32 326)
  br label %913
...
; <label>:913                                     ; preds = %910, %907, %904
  ...
  call void @wg_read_succ(i32 327)
  ...
  call void @wg_read_action(i32 328)
...
; <label>:925                                     ; preds = %924
  ...
  call void @wg_read_action(i32 329)
...
; <label>:929                                     ; preds = %925
  ...
  call void @wg_read_succ(i32 330)
  call void @fd_close(i32 %sock.2) nounwind
  br label %937
...
; <label>:930                                     ; preds = %913
  ...
  call void @wg_read_succ(i32 331)
  ...
  call void @wg_read_action(i32 332)
...
; <label>:936                                     ; preds = %930
  ...
  call void @wg_read_succ(i32 333)
  call void @fd_close(i32 %sock.2) nounwind
  br label %937
...
; <label>:942                                     ; preds = %940, %937
  ...
  call void @wg_read_action(i32 334)
  br label %945
...
; <label>:945                                     ; preds = %942, %885, %874, %.thread93, %770, %757, %705, %566, %563, %522, %367, %359, %342, %317, %313, %302, %298, %278, %277, %268, %267, %235, %232, %218, %12
  ...
  call void @wg_read_succ(i32 335)
  ret i32 %.0
}
...
define i32 @fork_retrieve_from_file(i8* %file, i1 zeroext %html) nounwind uwtable {
  ...
  call void @wg_read_action(i32 384)
  %noop_6 = add i32 %"ld_glob_ 3", %"ld_glob_ 3"
  call void @wg_read_succ(i32 385)
  call void @wg_read_action(i32 385)
  %noop_5 = add i32 %noop_6, %noop_6
  call void @wg_read_succ(i32 386)
  call void @wg_read_action(i32 386)
  %noop_4 = add i32 %noop_5, %noop_5
  call void @wg_read_succ(i32 336)
  call void @wg_read_action(i32 336)
  ...
  call void @wg_read_succ(i32 337)
  call void @wg_read_action(i32 337)
  ...
  call void @wg_read_succ(i32 338)
  ret i32 %2
}
...
define i32 @fork_retrieve_url(%struct.url* %orig_parsed, i8* %origurl, i8** %file, i8** %newloc, i8* %refurl, i32* %dt, i1 zeroext %recursive, %struct.iri* %iri, i1 zeroext %register_status) nounwind uwtable {
  ...
  call void @wg_read_action(i32 387)
  %noop_9 = add i32 %"ld_glob_ 6", %"ld_glob_ 6"
  call void @wg_read_succ(i32 388)
  call void @wg_read_action(i32 388)
  %noop_8 = add i32 %noop_9, %noop_9
  call void @wg_read_succ(i32 389)
  call void @wg_read_action(i32 389)
  %noop_7 = add i32 %noop_8, %noop_8
  call void @wg_read_succ(i32 339)
  call void @wg_read_action(i32 339)
  ...
  call void @wg_read_succ(i32 340)
  call void @wg_read_action(i32 340)
  ...
  call void @wg_read_succ(i32 341)
  ret i32 %3
}
...
define i32 @main(i32 %argc, i8** %argv) nounwind uwtable {
  ...
  call void @wg_read_action(i32 342)
  ...
  %4 = icmp eq i8* %3, null
  call void @wg_read_succ(i32 343)
  br i1 %4, label %5, label %7

; <label>:5                                       ; preds = %0
  %6 = load i8** %argv, align 8, !tbaa !0
  call void @wg_read_action(i32 344)
  br label %9

; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds i8* %3, i64 1
  call void @wg_read_action(i32 345)
  br label %9
...
; <label>:9                                       ; preds = %7, %5
  ...
  call void @wg_read_succ(i32 346)
  ...
  call void @wg_read_action(i32 347)
  br label %.backedge
...
.backedge:                                        ; preds = %129, %123, %76, %67, %63, %59, %51, %46, %37, %27, %9
  ...
  call void @wg_read_succ(i32 348)
...
; <label>:27                                      ; preds = %21, %12
  ...
  call void @wg_read_action(i32 349)
...
; <label>:37                                      ; preds = %27
  ...
  call void @wg_read_succ(i32 350)
  call void @setoptval(i8* %39, i8* %40, i8* %42) nounwind
  call void @wg_read_action(i32 351)
  br label %.backedge

; <label>:43                                      ; preds = %27
  %44 = load i8** @rpl_optarg, align 8, !tbaa !0
  %45 = icmp eq i8* %44, null
  call void @wg_read_action(i32 352)
...
; <label>:46                                      ; preds = %43
  ...
  call void @wg_read_succ(i32 353)
  call void @setoptval(i8* %48, i8* %44, i8* %50) nounwind
  call void @wg_read_action(i32 354)
  br label %.backedge
...
; <label>:51                                      ; preds = %43
  ...
  call void @wg_read_succ(i32 355)
  call void @setoptval(i8* %55, i8* %56, i8* %58) nounwind
  call void @wg_read_action(i32 356)
  br label %.backedge
...
; <label>:59                                      ; preds = %27
  ...
  %trans_fn4 = load i8* (i8*)** @trans_func
  %callee_cast = bitcast void ()* %62 to i8*
  %wrapped5 = call i8* %trans_fn4(i8* %callee_cast)
  %cast_call_44935280 = bitcast i8* (i8*)* %trans_fn4 to i8*
  call void @wg_read_ret(i8* %cast_call_44935280)
  %test6 = bitcast i8* %wrapped5 to void ()*
  call void %test6() nounwind
  %cast_call_42951560 = bitcast void ()* %test6 to i8*
  call void @wg_read_ret(i8* %cast_call_42951560)
  call void @wg_read_action(i32 357)
  br label %.backedge
...
; <label>:67                                      ; preds = %27
  ...
  call void @wg_read_succ(i32 360)
  call void @run_command(i8* %68) nounwind
  call void @wg_read_action(i32 361)
  br label %.backedge
...
; <label>:76                                      ; preds = %100, %69
  ...
  %78 = icmp eq i8 %77, 0
  call void @wg_read_action(i32 362)
  br i1 %78, label %.backedge, label %79

; <label>:79                                      ; preds = %76
  %80 = sext i8 %77 to i32
  call void @wg_read_action(i32 363)
...
; <label>:81                                      ; preds = %79
  ...
  call void @wg_read_succ(i32 364)
...
; <label>:83                                      ; preds = %79
  ...
  call void @wg_read_succ(i32 365)
...
; <label>:85                                      ; preds = %79
  ...
  call void @wg_read_succ(i32 366)
...
; <label>:87                                      ; preds = %79
  ...
  call void @wg_read_succ(i32 367)
...
; <label>:89                                      ; preds = %79
  ...
  call void @wg_read_succ(i32 368)
...
; <label>:102                                     ; preds = %27, %27
  ...
  call void @wg_read_action(i32 369)
...
; <label>:105                                     ; preds = %102
  ...
  call void @wg_read_action(i32 370)
...
; <label>:109                                     ; preds = %105
  ...
  %112 = icmp eq i32 %., 121
  call void @wg_read_action(i32 371)
  br i1 %112, label %123, label %113

; <label>:113                                     ; preds = %109
  %114 = icmp eq i32 %., 111
  call void @wg_read_action(i32 372)
...
; <label>:115                                     ; preds = %113
  ...
  call void @wg_read_action(i32 373)
  br label %123
...
; <label>:123                                     ; preds = %115, %113, %109, %105, %102
  ...
  call void @wg_read_succ(i32 374)
  call void @setoptval(i8* %126, i8* %flag.0, i8* %128) nounwind
  call void @wg_read_action(i32 375)
  br label %.backedge
...
; <label>:129                                     ; preds = %27
  ...
  call void @wg_read_succ(i32 376)
  ...
  call void @wg_read_action(i32 377)
  br label %.backedge
...
; <label>:190                                     ; preds = %187
  ...
  call void @wg_read_action(i32 378)
...
; <label>:196                                     ; preds = %190
  ...
  call void @wg_read_succ(i32 379)
...
; <label>:200                                     ; preds = %190, %187
  ...
  call void @wg_read_action(i32 380)
...
; <label>:207                                     ; preds = %205, %200
  ...
  %209 = icmp eq i8 %208, 0
  call void @wg_read_action(i32 1)
...
; <label>:258                                     ; preds = %254, %250
  ...
  call void @wg_read_action(i32 9)
...
; <label>:262                                     ; preds = %261, %258
  ...
  call void @wg_read_action(i32 11)
...
; <label>:294                                     ; preds = %._crit_edge74, %267
  ...
  %299 = icmp eq i8 %298, 0
  call void @wg_read_action(i32 19)
...
; <label>:361                                     ; preds = %.lr.ph69
  ...
  call void @wg_read_action(i32 29)
...
; <label>:377                                     ; preds = %372
  ...
  call void @wg_read_action(i32 36)
  br label %378
...
; <label>:380                                     ; preds = %370, %361
  ...
  call void @wg_read_succ(i32 38)
  call void @wg_read_action(i32 38)
  %trans_fn = load i8* (i8*)** @trans_func
  %wrapped = call i8* %trans_fn(i8* bitcast (i32 (%struct.url*, i8*, i8**, i8**, i8*, i32*, i1, %struct.iri*, i1)* @fork_retrieve_url to i8*))
  %cast_call_44934816 = bitcast i8* (i8*)* %trans_fn to i8*
  call void @wg_read_ret(i8* %cast_call_44934816)
  %test = bitcast i8* %wrapped to i32 (%struct.url*, i8*, i8**, i8**, i8*, i32*, i1, %struct.iri*, i1)*
  %384 = call i32 %test(%struct.url* %354, i8* %381, i8** %filename, i8** %redirected_URL, i8* null, i32* %dt, i1 zeroext %383, %struct.iri* @dummy_iri, i1 zeroext true)
  %cast_call_41804400 = bitcast i32 (%struct.url*, i8*, i8**, i8**, i8*, i32*, i1, %struct.iri*, i1)* %test to i8*
  call void @wg_read_ret(i8* %cast_call_41804400)
...
; <label>:395                                     ; preds = %394, %391
  ...
  call void @wg_read_action(i32 46)
...
; <label>:412                                     ; preds = %409
  ...
  call void @wg_read_action(i32 49)
  br label %413
...
; <label>:414                                     ; preds = %413, %356
  ...
  call void @wg_read_action(i32 51)
...
; <label>:420                                     ; preds = %._crit_edge70
  ...
  call void @wg_read_action(i32 53)
  %trans_fn1 = load i8* (i8*)** @trans_func
  %wrapped2 = call i8* %trans_fn1(i8* bitcast (i32 (i8*, i1)* @fork_retrieve_from_file to i8*))
  %cast_call_88254336 = bitcast i8* (i8*)* %trans_fn1 to i8*
  call void @wg_read_ret(i8* %cast_call_88254336)
  %test3 = bitcast i8* %wrapped2 to i32 (i8*, i1)*
  %423 = call i32 %test3(i8* %418, i1 zeroext %422)
  %cast_call_41811288 = bitcast i32 (i8*, i1)* %test3 to i8*
  call void @wg_read_ret(i8* %cast_call_41811288)
  %424 = icmp eq i32 %423, 0
  call void @wg_read_succ(i32 54)
...
; <label>:428                                     ; preds = %425, %420, %._crit_edge70
  ...
  call void @wg_read_action(i32 56)
...
; <label>:445                                     ; preds = %444, %439
  ...
  call void @wg_read_action(i32 60)
  ...
  call void @wg_read_action(i32 61)
  ...
  call void @wg_read_action(i32 64)
...
; <label>:477                                     ; preds = %477, %.lr.ph
  ...
  call void @wg_read_action(i32 74)
...
define fastcc i32 @marshall_gethttp(%struct.url*, %struct.http_stat*, i32*, %struct.url*) {
entry:
  ret i32 0
}

define i32 @marshall_fork_retrieve_from_file(i8*, i1) {
entry:
  %arg_slot_0 = alloca i8*
  %arg_slot_1 = alloca i1
  %arg_iovec = alloca { i8*, i64 }, i32 2
  ...
  %work_call = call { i8*, i64 }* %setup_fn(i32 2, { i8*, i64 }* %arg_iovec, i32 2)
  %work_res = getelementptr inbounds { i8*, i64 }* %work_call, i32 0, i32 0
  %work_ret_buf = load i8** %work_res
  %ret_val = call i32 @voidpp_to_int(i8* %work_ret_buf)
  ret i32 %ret_val
}

define i32 @marshall_fork_retrieve_url(%struct.url*, i8*, i8**, i8**, i8*, i32*, i1, %struct.iri*, i1) {
entry:
  ret i32 0
}

define { i8*, i64 }* @unmarshall_gethttp({ i8*, i64 }*) {
entry:
  ret { i8*, i64 }* null
}

define { i8*, i64 }* @unmarshall_fork_retrieve_from_file({ i8*, i64 }*) {
entry:
  %malloccall = tail call i8* @malloc(i32 ptrtoint (i32* getelementptr (i32* null, i32 1) to i32))
  %ret_slot = bitcast i8* %malloccall to i32*
  ...
  %work_res = call i32 @fork_retrieve_from_file(i8* %arg_0, i1 %arg_1)
  store i32 %work_res, i32* %ret_slot
  %void_res_buf = call i8* @int_to_voidp(i32* %ret_slot)
  %res_size = call i64 @int_size(i32 %work_res)
...
define { i8*, i64 }* @unmarshall_fork_retrieve_url({ i8*, i64 }*) {
entry:
  ret { i8*, i64 }* null
}
