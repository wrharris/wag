...
virt_ops="accept bind connect getsockopt fdopen fds fstat ftruncate listen lseek open poll pread pwrite read recv recvfrom recvmsg select send sendto sendmsg setsockopt socket socketpair write"
